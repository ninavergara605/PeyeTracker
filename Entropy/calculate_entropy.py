...
from PathUtilities.general_path_functions import normalize_path
import numpy as np
import pandas as pd
...
class CalculateEntropy:
    ...
    def __init__(self
        ...
        self._transition_counts, self._metadata = CreateTransitionMatrices(fixation_roi,target_roi).result   
